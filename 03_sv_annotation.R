...
# Genome assembly: GCF_019923935.1
# ============================================================================
...
# Check for out-of-bound genomic coordinates----------------------------------
...
# Create TxDb gene annotation database (if not yet created)-------------------
...
# Harmonize chromosome naming between SV and gene annotations ----------------
...
# Identify overlaps between structural variants and genes --------------------
hits <- findOverlaps(
  sv_gr,
  genes_gr,
  ignore.strand = TRUE
...
# Collapse multiple gene hits per SV------------------------------------------
...
# Annotate Structural Variants with gene information--------------------------

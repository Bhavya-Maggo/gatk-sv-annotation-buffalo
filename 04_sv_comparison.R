...
# 2 samples/individuals ka comparison
# =============================================================================
...
#write.csv(data.frame(gene = shared_genes),
#          "shared_genes.csv",     row.names = FALSE)

#write.csv(data.frame(gene = unique_gene_sv1),
#          "donor_only_genes.csv", row.names = FALSE)

#write.csv(data.frame(gene = unique_gene_sv2),
#         "clone_only_genes.csv", row.names = FALSE)
...
p1
#ggsave("plot1_svtype.png",
#       plot = p1, width = 8, height = 5, dpi = 600)
...
p2
#ggsave("plot2_shared_unique.png",
#       plot = p2, width = 6, height = 5, dpi = 600)

# Plot 3: Venn Diagram — SVs
p3 <- ggvenn(
...
#ggsave("plot3_venn_SVs.png",
 #      plot = p3, width = 6, height = 5, dpi = 600)

# Plot 4: Venn Diagram — Genes ─────────────────────────────────────────────
p4 <- ggvenn(
...
#ggsave("plot4_venn_genes.png",
 #      plot = p4, width = 6, height = 5, dpi = 600)

# Plot 5: Chromosome Distribution 
chr_df <- combined %>% dplyr::count(sample, seqnames)
...
#ggsave("plot5_chromosome.png",
#       plot = p5, width = 12, height = 6, dpi = 600)


# Plot 6: Biotype Comparison
...
#ggsave("plot6_biotype.png",
#       plot = p6, width = 9, height = 6, dpi = 600)


# Plot 7: Top 20 Genes Side by Side 
...
#ggsave("plot7_top20_genes.png",
#       plot = p7, width = 14, height = 7, dpi = 600)
